...
function Background() {
  return (
    <div className="relative w-full h-[100vh] text-white overflow-hidden ">
      <div className="absolute z-20 top-1 left-12">
      ...
      ></div>
      <main className="absolute z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-wiggle font-Poppins font-medium">
       Explore
      </main>
